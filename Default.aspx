...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-4">
        ...
        <p style="color: white">Explore a variety of local eateries in Tamil Nadu serving traditional dishes.</p><br />
    ...
    <div class="col-md-4">
        ...
        <p style="color: white">Discover a collection of delicious Tamil Nadu recipes and learn how to prepare them at home.</p><br />
    ...
    <div class="col-md-4">
        ...
        <p style="color: white">Dive into the rich food culture of Tamil Nadu and explore captivating stories and articles.</p><br />
