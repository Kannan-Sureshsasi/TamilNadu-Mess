    ...
    <asp:Table ID="orderTable" runat="server" Width="100%" BorderStyle="Solid" BorderWidth="1px" CellPadding="10" HorizontalAlign="Center" Height="397px">
        <asp:TableRow>
            ...
            <asp:TableCell>
                ...
                <asp:Label ID="TAount" runat="server" Font-Bold="true" Font-Size="Medium" Font-Names="visage" ForeColor="White"></asp:Label>
            </asp:TableCell>
            <asp:TableCell>
                <asp:Label ID="lblSelectedItem" runat="server" Text="Selected Item → " ForeColor="#B106D9" Font-Bold="true"></asp:Label>
                <asp:Label ID="Sitem" runat="server" Font-Bold="true" Font-Size="Medium" Font-Names="visage" ForeColor="White"></asp:Label>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
